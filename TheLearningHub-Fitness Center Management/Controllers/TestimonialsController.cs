...
namespace TheLearningHub_Fitness_Center_Management.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TestId,TestText,IsApproved,Rating,UserId")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestId,TestText,IsApproved,Rating,UserId")] Testimonial testimonial)
        {
